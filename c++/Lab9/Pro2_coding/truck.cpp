...
{
   return Vehicle::getTransmissionType();
}

int  Truck::getNumberOfDoors() const 
{
   return Vehicle::getNumberOfDoors();
}

int  Truck::getNumberOfCylinders() const 
{
   return Vehicle::getNumberOfCylinders();
}
