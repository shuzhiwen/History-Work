...
public class DTest implements DAO{
	...
	public void add(Student st){
		...
		try{
			...
			cmd.executeUpdate();
			System.out.println("insert stu id="+st.getId()+" "+"name="+st.getName()+" "+"score="+st.getScore());
		}catch(SQLException e){
			e.printStackTrace();
		}
	}
	...
	public void update(Student st){
		...
		try{
			...
			cmd.executeUpdate();
			System.out.println("update stu id="+st.getId()+" "+"name="+st.getName()+" "+"score="+st.getScore());
		}catch(SQLException e){
			e.printStackTrace();
		}
	}
